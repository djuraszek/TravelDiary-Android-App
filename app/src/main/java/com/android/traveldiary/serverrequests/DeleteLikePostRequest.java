...
public class DeleteLikePostRequest extends StringRequest {
    ...
    public DeleteLikePostRequest(String token, int id, Response.Listener<String> listener, Response.ErrorListener errorListener) {
