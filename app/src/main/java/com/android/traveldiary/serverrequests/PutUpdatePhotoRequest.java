...
public class PutUpdatePhotoRequest extends Request<NetworkResponse> {
    ...
    public PutUpdatePhotoRequest(String token, int photoID,
                                 Response.Listener<NetworkResponse> listener,
                                 Response.ErrorListener errorListener) {
        super(Method.POST, UPDATE_PHOTO_URL+photoID+METHOD_PUT, errorListener);
    ...
    public byte[] getBody() throws AuthFailureError {
        ...
        try {
            ...
            if (params != null && params.size() > 0) {
                Log.i("VolleyMultipartRequest","params not empty");
